...
def run_pipeline():
    ...
    try:
        ...
        # Calcul des segments clients (nécessite les commandes nettoyées)
        ...
        try:
            ...
            # Sauvegarder en local pour vérification
            ...
            logging.info(f"Données sauvegardées localement dans {settings.DATA_DIR} pour le dashboard.")
